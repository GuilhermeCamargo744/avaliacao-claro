...
export const homeTeamTasksStyles = tv({
  slots: {
    ...
    header: 'items-center gap-1 pb-4 pt-4',
    title: 'text-2xl font-bold text-content',
    subtitle: 'text-base text-content-muted',
    filters: 'gap-3 pb-4',
    statusRow: 'flex-row gap-2',
    statusChip: 'rounded-full bg-sunken px-3 py-1.5',
    statusChipLabel: 'text-xs font-bold text-content',
    list: 'flex-1',
    listContent: 'gap-4 pb-2',
    loadMore: 'items-center py-4',
  ...
  variants: {
    selected: {
      true: {
        statusChip: 'bg-accent',
        statusChipLabel: 'text-on-accent',
      },
    },
  },
});
